        ...
        <section>
            ...
            <el-form :model="ruleForm2" :rules="rules2" status-icon show-message ref="abc" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="用户账号" prop="user_name">
                    ...
                    <el-input type="text" v-model="ruleForm2.user_name" auto-complete="off" class="login_input">
                    </el-input>
                </el-form-item>

                <el-form-item label="用户姓名" prop="user_namer">
                    <!-- 双向数据绑定对象的密码,这个对象就是传入后台的参数对象 -->
                    <el-input type="password" v-model="ruleForm2.user_namer" auto-complete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item label="邮箱地址" prop="eamil">
                    <!-- v-model双向数据绑定, 需要绑定data里的数据, 将来要把这些数据提交给后端 -->
                    <el-input type="email" v-model="ruleForm2.eamil" auto-complete="off" class="login_input">
                    </el-input>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button type="success" @click="submitForm('abc')">注册账号</el-button>
  ...
  data() {
    return {
      ...
      rules2: {
        ...
        eamil: [{ required: true, message: "请输入邮箱", trigger: "blur" }],
        telephone: [{ required: true, message: "请输入手机号", trigger: "blur" }],
        yz_register: [{ required: true, message: "请输入验证码", trigger: "blur" }],
      }
    };
  },
  methods: {
